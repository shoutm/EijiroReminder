FactoryGirl.define do
  ...
  # -----------------------------------------
  factory :super_class_of_tag, :class => 'Er::Tag' do
    # If same tag already exists in DB, reuse it.
    initialize_with { Er::Tag.find_or_create_by(
      tag: tag, name: name, interval: interval, order: order) }
